...
public class autormoveball : MonoBehaviour
{
    [SerializeField] public float moveSpeed = 2.5f; // Speed of the object's movement
    [SerializeField] public float moveLimit = 7.0f; // The limit to move between -moveLimit and +moveLimit on the x-axis
